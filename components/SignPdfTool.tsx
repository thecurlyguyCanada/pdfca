            ...
            {pageSize.width > 0 && entries.map(entry => (
                <Rnd
                    ...
                    resizeHandleStyles={{
                        ...
                        bottomLeft: { width: isMobile ? 64 : 24, height: isMobile ? 64 : 24, bottom: isMobile ? -32 : -12, left: isMobile ? -32 : -12, background: '#3b82f6', borderRadius: '50%', border: '4px solid white', boxShadow: '0 4px 12px rgba(0,0,0,0.3)', zIndex: 100, cursor: 'nesw-resize', touchAction: 'none', pointerEvents: 'auto' },
                        bottomRight: { width: isMobile ? 64 : 24, height: isMobile ? 64 : 24, bottom: isMobile ? -32 : -12, right: isMobile ? -32 : -12, background: '#3b82f6', borderRadius: '50%', border: '4px solid white', boxShadow: '0 4px 12px rgba(0,0,0,0.3)', zIndex: 100, cursor: 'nwse-resize', touchAction: 'none', pointerEvents: 'auto' },
                        top: { display: 'none' },
                        right: { display: 'none' },
                        bottom: { display: 'none' },
                        left: { display: 'none' },
