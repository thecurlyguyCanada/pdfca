    ...
    return (
        <PageLayout
            ...
            breadcrumbs={[
                ...
                { name: lang === 'fr' ? 'GIF en PDF' : (lang === 'pt' ? 'GIF para PDF' : 'GIF to PDF'), href: '#' }
            ]}
        >
            ...
            <div className="w-full py-12">
                ...
                <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link href={`/${lang}/guides/png-to-pdf`} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700 dark:text-gray-300">
                            <Zap size={16} className="text-canada-red" />
                            {lang === 'fr' ? 'Guide PNG vers PDF' : (lang === 'pt' ? 'Guia PNG para PDF' : 'PNG to PDF Guide')}
                        </Link>
