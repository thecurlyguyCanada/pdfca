            ...
            },
            {
                ...
                content: (
                    <div className="space-y-4">
                        ...
                        <p><strong>Organizing Merged Documents</strong>: You merged multiple PDFs using our <Link href="/merge-pdf" className="text-canada-red hover:underline">Merge PDF tool</Link>, but the sections are out of order. Rearrange them into a logical flow.</p>
            ...
            },
            {
                ...
                content: (
                    <ul className="list-disc pl-5 space-y-3">
                        ...
                        <li><strong>Combine with Other Tools</strong>: Use our <Link href="/delete-pdf-pages" className="text-canada-red hover:underline">Delete Pages tool</Link> to remove unwanted pages before organizing, creating a cleaner final document.</li>
                    </ul>
                )
            },
            {
            ...
            },
            {
                ...
                content: (
                    <div className="space-y-4">
                        ...
                        <p><strong>Organisation de documents fusionnés</strong> : Vous avez fusionné plusieurs PDF en utilisant notre <Link href="/merge-pdf" className="text-canada-red hover:underline">outil de fusion PDF</Link>, mais les sections sont dans le désordre. Réarrangez-les dans un flux logique.</p>
            ...
            },
            {
                ...
                content: (
                    <ul className="list-disc pl-5 space-y-3">
                        ...
                        <li><strong>Combinez avec d'autres outils</strong> : Utilisez notre <Link href="/delete-pdf-pages" className="text-canada-red hover:underline">outil de suppression de pages</Link> pour retirer les pages indésirables avant d'organiser, créant un document final plus propre.</li>
                    </ul>
                )
            },
            {
                ...
                <div className="max-w-4xl mx-auto py-8">
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/10 p-8 rounded-[2rem] border border-amber-200 dark:border-amber-800 flex gap-6 mb-16">
                        ...
                        <p className="text-lg text-amber-900 dark:text-amber-300">
                            <strong>Insider Tip:</strong> You can combine this tool with our <Link href="/delete-pdf-pages" className="underline decoration-dashed hover:decoration-solid hover:text-amber-800">'Delete Pages' tool</Link> to perfectly curate your final document before sharing. Perfect for clean board reports!
                        </p>
                    </div>
