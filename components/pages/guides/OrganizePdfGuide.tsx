                ...
                <div className="w-full py-4 sm:py-6 md:py-8">
                    ...
                    <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Link href={`/${lang}/guides/rotate-pdf`} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700 dark:text-gray-300">
                                <ArrowRight size={16} className="text-canada-red" />
                                {lang === 'fr' ? 'Guide Pivoter PDF' : (lang === 'pt' ? 'Guia Girar PDF' : 'Rotate PDF Guide')}
                            </Link>
                        </div>
                    </div>
