...
1. **Upload Your PDF File**: Click to browse or drag-and-drop your PDF document into our <Link href="/${lang}/pdf-to-word" className="text-canada-red hover:underline font-medium">PDF to Word converter</Link>. The file stays on your device—never uploaded to our servers.
...
1. **Téléchargez votre fichier PDF** : Cliquez pour parcourir ou glissez-déposez votre document PDF dans notre <Link href="/${lang}/pdf-to-word" className="text-canada-red hover:underline font-medium">convertisseur PDF vers Word</Link>. Le fichier reste sur votre appareil—jamais téléchargé sur nos serveurs.
