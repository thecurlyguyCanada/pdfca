        ...
        <div className="bg-white dark:bg-gray-950">
            <SEO
                ...
                breadcrumbs={[
                    ...
                    { name: lang === 'fr' ? 'OCR & Analyse' : (lang === 'pt' ? 'OCR & Análise' : 'OCR & Analysis'), path: lang === 'fr' ? '/fr/guides/pdf-ocr-analysis' : (lang === 'pt' ? '/pt/guides/pdf-ocr-analysis' : '/guides/pdf-ocr-analysis') }
                ]}
            />
            <PageLayout
                title={t.h1}
