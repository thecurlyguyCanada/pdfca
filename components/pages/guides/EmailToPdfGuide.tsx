...
const getGuideContent = (lang: Language) => ({
    en: {
        ...
        ctaTitle: "Need to Clean Up Your Saved Emails? Use Our Free Tool!",
        ctaButton: "Remove Pages Now",
    ...
    fr: {
        ...
        ctaTitle: "Besoin de nettoyer vos PDF ? Utilisez notre outil gratuit !",
