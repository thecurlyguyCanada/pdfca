                ...
                content: (
                    <>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button onClick={() => onNavigate('TOOL_PAGE', '/ocr-pdf')} className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-2 rounded-xl text-sm font-medium hover:border-canada-red transition-colors">
                                <Zap size={14} className="text-canada-red" /> Run OCR to make text editable
                            </button>
                            <button onClick={() => onNavigate('TOOL_PAGE', '/sign-pdf')} className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-2 rounded-xl text-sm font-medium hover:border-canada-red transition-colors">
                                <Edit3 size={14} className="text-canada-red" /> Add a secure signature
                            </button>
                            <button onClick={() => onNavigate('TOOL_PAGE', '/compress-pdf')} className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-2 rounded-xl text-sm font-medium hover:border-canada-red transition-colors">
...
export const EditXfaPdfGuide: React.FC<GuideProps> = ({ lang, onNavigate }) => {
        ...
        <>
            <SEO
                ...
                breadcrumbs={[
                    ...
                    { name: 'Edit XFA PDF', path: '/guides/edit-xfa-pdf' }
                ]}
            />
