        ...
        sections: [
            {
                ...
                content: (
                    <>
                        <Image src="/images/guides/flatten-pdf-guide.png" alt="Flatten PDF illustration" width={800} height={450} className="w-full h-auto rounded-xl shadow-md mb-8" />
                        <p className="mb-4">
        ...
        <>
            ...
            <PageLayout title={t.h1} subtitle={t.subtitle} icon={<Lock size={32} />}>
                <div className="w-full space-y-8 sm:space-y-12 md:space-y-16 text-gray-700 dark:text-gray-300">
                    <ToolPromo tool="make-pdf-non-editable" lang={lang} />
                    {/* Introduction */}
                    ...
                    <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Link href={`/${lang}/guides/sign-pdf`} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700 dark:text-gray-300">
                                <FileText size={16} className="text-canada-red" />
                                {lang === 'fr' ? 'Signer un PDF' : (lang === 'pt' ? 'Assinar PDF' : 'Sign PDF')}
                            </Link>
