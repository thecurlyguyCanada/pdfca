...
const getGuideContent = (lang: Language) => ({
 ...
 <p className="text-yellow-800"><strong>Solution</strong>: Flattening creates image layers which can be larger than text. Use our <Link href="/${lang}/compress-pdf" className="text-canada-red hover:underline font-semibold">Compress tool</Link> with medium quality to reduce size by 40-60%.</p>
 </div>
 <div className="p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
