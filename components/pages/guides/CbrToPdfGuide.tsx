                ...
                <div className="w-full space-y-8 sm:space-y-12 md:space-y-16">
                    ...
                    <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href={`/${lang}/guides/acsm-to-pdf`} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700 dark:text-gray-300">
                                <BookOpen size={16} className="text-canada-red" />
                                {lang === 'fr' ? 'Guide ACSM vers PDF' : (lang === 'pt' ? 'Guia ACSM para PDF' : 'ACSM to PDF Guide')}
                            </Link>
                            <Link href={`/${lang}/guides/pdf-to-kindle`} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700 dark:text-gray-300">
                                <BookOpen size={16} className="text-canada-red" />
                                {lang === 'fr' ? 'Guide PDF vers Kindle' : (lang === 'pt' ? 'Guia PDF para Kindle' : 'PDF to Kindle Guide')}
                            </Link>
                            <Link href={`/${lang}/guides/image-to-pdf`} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700 dark:text-gray-300">
                                <Download size={16} className="text-canada-red" />
                                {lang === 'fr' ? 'Guide Images vers PDF' : (lang === 'pt' ? 'Guia Imagens para PDF' : 'Image to PDF Guide')}
                            </Link>
