        ...
        <>
            <SEO
                ...
                breadcrumbs={[
                    ...
                    { name: lang === 'fr' ? 'Insérer une Image' : (lang === 'pt' ? 'Inserir Imagem' : 'Insert Picture in PDF'), path: lang === 'fr' ? '/fr/guides/insert-picture-in-pdf' : (lang === 'pt' ? '/pt/guides/insert-picture-in-pdf' : '/guides/insert-picture-in-pdf') }
                ]}
            />
            ...
            <PageLayout
                ...
                breadcrumbs={[
                    ...
                    { name: lang === 'fr' ? 'Insérer une Image' : (lang === 'pt' ? 'Inserir Imagem' : 'Insert Picture in PDF'), href: '#' }
                ]}
            >
