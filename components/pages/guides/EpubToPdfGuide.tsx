...
- **Gérer les images** : Les illustrations sont intégrées en haute résolution pour ne pas perdre en qualité lors d'un zoom.`
        ...
        faq: [
            ...
            },
            {
                ...
                a: "No. Si votre livre est protégé par un verrou numérique (Digital Rights Management), notre outil ne pourra pas y accéder. Assurez-vous que votre fichier est libre de droits ou sans DRM."
            },
            {
